...
public class collectorCompletedJobsController implements Initializable {
    ...
    public TableColumn<takenJobTableObject, Date> submittedDate;
    ...
    public void submitSampleOnAction(ActionEvent actionEvent) throws IOException {
        Parent root= FXMLLoader.load(getClass().getResource("collectorPage.fxml"));
        Stage stage = (Stage)((Node)actionEvent.getSource()).getScene().getWindow();
        stage.setScene(new Scene(root));
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        submittedDate.setCellValueFactory(new PropertyValueFactory<takenJobTableObject,Date>("submittedDate"));
        ...
        try {
            ...
            SQL="select test_name,patient_username,package_id,collector_taken_date,sample_submission_date,order_id from orders where collector_id = '" +collectorId + "' and " +
            ...
            while(rs.next())
            {
                ...
                rs2.next();
                list.add(new takenJobTableObject(rs.getString(1),rs2.getString(1),
                        rs2.getString(2),String.valueOf(rs.getInt(3)),rs.getDate(4),
